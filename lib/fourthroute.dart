...
class fourthRoute extends StatefulWidget {
  const fourthRoute({Key? key, required this.title}) : super(key: key);
  final String title;
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          ...
          BottomNavigationBarItem(icon:Icon(Icons.medical_services_rounded),
              label: 'Services',
              // backgroundColor: Colors.lightGreen
          ),

          BottomNavigationBarItem(icon:Icon(Icons.card_giftcard_rounded),
              label: 'Order',
              // backgroundColor: Colors.lightGreen
          ),
